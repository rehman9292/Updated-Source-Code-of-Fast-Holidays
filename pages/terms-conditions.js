      ...
      <div className={styles.txtPage}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.subSection}>
            ...
            <Typography>
              ...
              for election of directors or other managing authority. Country
              refers to: United Kingdom Company (referred to as either "the
              Company", "We", "Us" or "Our" in this Agreement) refers to ${appName}. Device means any device that can access the Service such
              as a computer, a cellphone or a digital tablet. Service refers to
              the Website. Terms and Conditions (also referred as "Terms") mean
              ...
              Website refers to ${appName}, accessible from
              ${appLink} You means the individual accessing or
        ...
        <div className={styles.section}>
          ...
          <Typography>
            ...
            to read the terms and conditions and privacy policies of any third-
        ...
        <div className={styles.section}>
          ...
          <Typography>
            ...
            <a href={`${appLink}/contact-us`}>{appLink}/contact-us</a>
            <br /> By phone number:<a href={`tel:${number}`}>{number}</a>
          </Typography>
        </div>
      </div>
    </Layout>
